...
<package name="CAP">
<pad name="IN" x="-1.27" y="0" drill="0.8" shape="square"/>
...
<text x="0" y="-7.62" size="1.778" layer="94">RN42XV</text>
</symbol>
<symbol name="CAP">
...
<deviceset name="RN42XV_SIMPLE">
<gates>
<gate name="G$1" symbol="RN42XV_SIMPLE" x="0" y="0"/>
</gates>
<devices>
<device name="" package="RN42XV_SIMPLE">
<connects>
<connect gate="G$1" pin="GND" pad="GND"/>
...
<part name="VCC_3V3@2" library="workoutAid" deviceset="VCC" device=""/>
<part name="VCC_3V3@1" library="workoutAid" deviceset="VCC" device=""/>
...
<part name="VCC_3V3@3" library="workoutAid" deviceset="VCC" device=""/>
...
<part name="U$20" library="workoutAid" deviceset="RN42XV_SIMPLE" device=""/>
<part name="VCC_VBAT" library="workoutAid" deviceset="VCC" device=""/>
<part name="U$5" library="workoutAid" deviceset="CAP" device=""/>
</parts>
<sheets>
<sheet>
<plain>
<text x="20.32" y="104.14" size="1.778" layer="97">VBAT</text>
<text x="5.08" y="91.44" size="1.778" layer="97">3v3</text>
<text x="106.68" y="91.44" size="1.778" layer="97">3v3</text>
<text x="66.04" y="20.32" size="1.778" layer="97">3v3</text>
<text x="17.78" y="20.32" size="1.778" layer="97" rot="R90">Note: A6 and A7 must use AnalogRead</text>
<text x="43.18" y="-25.4" size="1.778" layer="97">Cap Code:
102</text>
</plain>
<instances>
...
<instance part="VCC_3V3@2" gate="G$1" x="104.14" y="88.9"/>
<instance part="VCC_3V3@1" gate="G$1" x="2.54" y="88.9"/>
...
<instance part="VCC_3V3@3" gate="G$1" x="63.5" y="17.78"/>
...
<instance part="U$20" gate="G$1" x="124.46" y="68.58"/>
<instance part="VCC_VBAT" gate="G$1" x="17.78" y="101.6"/>
...
<pinref part="VCC_3V3@1" gate="G$1" pin="VCC"/>
...
<segment>
<pinref part="U$1" gate="G$1" pin="RX@2"/>
...
<segment>
<pinref part="U$1" gate="G$1" pin="TX@2"/>
...
<segment>
<pinref part="VCC_VBAT" gate="G$1" pin="VCC"/>
...
<pinref part="U$3" gate="G$1" pin="VBAT@2"/>
